"""
Django settings for demo_1212_1 project.
...
WSGI_APPLICATION = 'demo_1212_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_1212_1 API",
    "DESCRIPTION": "API documentation for demo_1212_1 App",
    "VERSION": "v1",
}
